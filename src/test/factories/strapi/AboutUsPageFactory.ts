...
class AboutUsPageFactory extends BaseFactory<AboutUsPageStrapiContent> {
  constructor() {
    super(
      ...
      `${import.meta.env.VITE_BASE_URL}/api/about-us-page?populate[0]=landingImage.image&populate[1]=sections.image&populate[2]=sections.link&populate[3]=sections.linkIcon&populate[4]=imageButtonSection.imageButtons&populate[5]=imageButtonSection.imageButtons.image`
    );
  }
}
